...
First, install the additional tagging dependencies as follows, creating or activating a `venv` as needed:

```bash
python3 -m venv ./venv
source ./venv/bin/activated 
pip -r hacking/tagger/requirements.txt
```
...
./hacking/tagger/tag.py tag --remote <name>
```
