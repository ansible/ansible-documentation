...
1. When running ``ansible-test`` from a clone of ``ansible-core``, in the same terminal session and being in its source code directory, run:
...
3. To run all sanity tests in a container:
