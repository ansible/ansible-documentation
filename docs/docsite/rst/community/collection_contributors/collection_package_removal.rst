...
#. Announce upcoming removal in the Ansible meta-data (``https://github.com/ansible-community/ansible-build-data/blob/main/<X>/collection-meta.yaml``).
   See the following link for an `example on how to do it <https://github.com/ansible-community/ansible-build-data/pull/477/files>`__.
