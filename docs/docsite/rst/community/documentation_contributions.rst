...
The Documentation Working Group (DaWGs) meets weekly on Tuesdays in the `docs:ansible.im <https://matrix.to/#/#docs:ansible.im>`_ chat room on :ref:`Matrix<communication_irc>`. For more information, including links to our agenda, visit our `forum group <https://forum.ansible.com/g/Docs>`_.
