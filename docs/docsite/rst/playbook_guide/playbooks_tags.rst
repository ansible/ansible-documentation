...
Tag precedence
--------------
Skipping always trumps explict tags, for example, if you specify both ``--tags`` and ``--skip-tags`` the latter has precedence. For example ``--tags tag1,tag3,tag4 --skip-tags tag3`` will only run tag1 and tag4 tasks.
