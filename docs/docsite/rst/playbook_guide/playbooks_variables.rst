...
Variables set in one role are available to later roles. You can set variables in a ``roles/common_settings/vars/main.yml`` file or ``roles/common_settings/vars/main`` directory and use them in other roles and elsewhere in your playbook:
